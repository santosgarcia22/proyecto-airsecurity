...
<div class="content-wrapper">
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <button type="button" class="btn btn-outline-primary btn-sm" data-toggle="modal"
                                            data-target="#accModal" data-idc="{{ $it->id_control_aeronave }}">
                                            Accesos
                                        </button>
                                        ...
                                        <button type="button" class="btn btn-danger btn-sm"
                                            onclick="delItem({{ $it->id_control_aeronave }})">Eliminar</button>
                                    </td>
                                </tr>
    ...
    <div class="modal fade" id="accModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <form  action="{{ route('admin.controlaeronave.storeAcceso') }}" id="accForm" method="POST" enctype="multipart/form-data">
                @csrf
