    ...
    <table class="box mt-4">
        ...
        <tr>
            ...
            <td colspan="2">
                <b>Agente Firma:</b>
                @php
                $agenteFirmaB64 = $header->agente_firma
                ?
                'data:'.mime_content_type(storage_path('app/public/'.$header->agente_firma)).';base64,'.base64_encode(file_get_contents(storage_path('app/public/'.$header->agente_firma)))
                : null;
                @endphp
                @if($agenteFirmaB64)
                <img src="{{ $agenteFirmaB64 }}" style="height:22px">
                @endif
            </td>
    ...
    <table class="box mt-4">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="hcell">
                    @if(!empty($r->firma_b64))
                    <img src="{{ $r->firma_b64 }}" style="height:22px">
                    @endif
                </td>
